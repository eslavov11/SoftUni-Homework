...
namespace MusicShopManager.Engine.Factories
{
    ...
    public class ArticleFactory : IArticleFactory
    {
        ...
        {
            return new ElectricGuitar(make, model, price, color, bodyWood,
                fingerboardWood, numberOfAdapters, numberOfFrets);
        }
        ...
        {
            return new AcousticGuitar(make, model, price, color, bodyWood,
                fingerboardWood, caseIncluded, stringMaterial);
        }
