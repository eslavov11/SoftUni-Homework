namespace AirConditionerTesterSystem.Utility
{
    public static class Constants
    {
        ...
        public const string NonExistandEntry = "The specified entry does not exist.";
        ...
        public const string ReportDelimiter = "====================";
