                ...
                <c:forEach items="${gameViewModels}" var="game" varStatus="gamesCount">
                    ...
                    <div class="card col-4 thumbnail">
                        ...
                        <div class="card-footer">
                            <a class="card-button btn btn-warning" name="edit" href="${pageContext.request.contextPath}/games/edit/${game.id}">Edit</a>
                            <a class="card-button btn btn-danger" name="delete" href="${pageContext.request.contextPath}/games/delete/${game.id}">Delete</a>
