...
${OBJECTDIR}/Bitwise\ Extract\ Bit\ #3.o: Bitwise\ Extract\ Bit\ #3.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Bitwise\ Extract\ Bit\ #3.o Bitwise\ Extract\ Bit\ #3.c

.NO_PARALLEL:${OBJECTDIR}/Problem\ 1.\ First\ Bit.o
${OBJECTDIR}/Problem\ 1.\ First\ Bit.o: Problem\ 1.\ First\ Bit.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 1.\ First\ Bit.o Problem\ 1.\ First\ Bit.c
...
${OBJECTDIR}/Problem\ 2.\ Extract\ Bit\ from\ Integer.o: Problem\ 2.\ Extract\ Bit\ from\ Integer.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 2.\ Extract\ Bit\ from\ Integer.o Problem\ 2.\ Extract\ Bit\ from\ Integer.c
...
${OBJECTDIR}/Problem\ 3.\ Check\ a\ Bit\ at\ Given\ Position.o: Problem\ 3.\ Check\ a\ Bit\ at\ Given\ Position.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 3.\ Check\ a\ Bit\ at\ Given\ Position.o Problem\ 3.\ Check\ a\ Bit\ at\ Given\ Position.c

.NO_PARALLEL:${OBJECTDIR}/Problem\ 4.\ Bit\ Destroyer.o
${OBJECTDIR}/Problem\ 4.\ Bit\ Destroyer.o: Problem\ 4.\ Bit\ Destroyer.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 4.\ Bit\ Destroyer.o Problem\ 4.\ Bit\ Destroyer.c
...
${OBJECTDIR}/Problem\ 5.\ Modify\ a\ Bit\ at\ Given\ Position.o: Problem\ 5.\ Modify\ a\ Bit\ at\ Given\ Position.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 5.\ Modify\ a\ Bit\ at\ Given\ Position.o Problem\ 5.\ Modify\ a\ Bit\ at\ Given\ Position.c

.NO_PARALLEL:${OBJECTDIR}/Problem\ 6.\ Bits\ Exchange.o
${OBJECTDIR}/Problem\ 6.\ Bits\ Exchange.o: Problem\ 6.\ Bits\ Exchange.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 6.\ Bits\ Exchange.o Problem\ 6.\ Bits\ Exchange.c
...
${OBJECTDIR}/Problem\ 7.\ Bits\ Exchange\ \(Advanced\).o: Problem\ 7.\ Bits\ Exchange\ \(Advanced\).c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 7.\ Bits\ Exchange\ \(Advanced\).o Problem\ 7.\ Bits\ Exchange\ \(Advanced\).c
