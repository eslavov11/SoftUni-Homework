...
${OBJECTDIR}/Problem\ 1.\ Print\ File\ Contents.o: Problem\ 1.\ Print\ File\ Contents.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 1.\ Print\ File\ Contents.o Problem\ 1.\ Print\ File\ Contents.c

.NO_PARALLEL:${OBJECTDIR}/Problem\ 2.\ Odd\ Lines.o
${OBJECTDIR}/Problem\ 2.\ Odd\ Lines.o: Problem\ 2.\ Odd\ Lines.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 2.\ Odd\ Lines.o Problem\ 2.\ Odd\ Lines.c

.NO_PARALLEL:${OBJECTDIR}/Problem\ 3.\ Line\ Numbers.o
${OBJECTDIR}/Problem\ 3.\ Line\ Numbers.o: Problem\ 3.\ Line\ Numbers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 3.\ Line\ Numbers.o Problem\ 3.\ Line\ Numbers.c
...
${OBJECTDIR}/Problem\ 6.\ Fix\ Subtitles.o: Problem\ 6.\ Fix\ Subtitles.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 6.\ Fix\ Subtitles.o Problem\ 6.\ Fix\ Subtitles.c
