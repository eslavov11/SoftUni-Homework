...
${OBJECTDIR}/BankAccountData.o: BankAccountData.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BankAccountData.o BankAccountData.c

${OBJECTDIR}/ComparingFloats.o: ComparingFloats.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ComparingFloats.o ComparingFloats.c

${OBJECTDIR}/DeclareVariables.o: DeclareVariables.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DeclareVariables.o DeclareVariables.c

${OBJECTDIR}/EmployeeData.o: EmployeeData.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EmployeeData.o EmployeeData.c

${OBJECTDIR}/ExchangeVariableValues.o: ExchangeVariableValues.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExchangeVariableValues.o ExchangeVariableValues.c

${OBJECTDIR}/FloatOrDouble.o: FloatOrDouble.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FloatOrDouble.o FloatOrDouble.c

${OBJECTDIR}/Gender.o: Gender.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gender.o Gender.c

${OBJECTDIR}/Names.o: Names.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Names.o Names.c

${OBJECTDIR}/PrintTheAsciiTable.o: PrintTheAsciiTable.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PrintTheAsciiTable.o PrintTheAsciiTable.c

${OBJECTDIR}/QuotesInString.o: QuotesInString.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QuotesInString.o QuotesInString.c

${OBJECTDIR}/VariableInHexademicalFormat.o: VariableInHexademicalFormat.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VariableInHexademicalFormat.o VariableInHexademicalFormat.c
