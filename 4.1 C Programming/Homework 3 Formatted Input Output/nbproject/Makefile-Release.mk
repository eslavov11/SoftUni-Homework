...
${OBJECTDIR}/CirclePerimeterAndArea.o: CirclePerimeterAndArea.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CirclePerimeterAndArea.o CirclePerimeterAndArea.c

${OBJECTDIR}/FibonacciNumbers.o: FibonacciNumbers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FibonacciNumbers.o FibonacciNumbers.c
...
${OBJECTDIR}/NumbersInIntervalDevidableByGivenNumber.o: NumbersInIntervalDevidableByGivenNumber.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NumbersInIntervalDevidableByGivenNumber.o NumbersInIntervalDevidableByGivenNumber.c

${OBJECTDIR}/PrintCompanyInformation.o: PrintCompanyInformation.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PrintCompanyInformation.o PrintCompanyInformation.c

${OBJECTDIR}/SumFromOneToN.o: SumFromOneToN.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SumFromOneToN.o SumFromOneToN.c

${OBJECTDIR}/SumOfFiveNumbers.o: SumOfFiveNumbers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SumOfFiveNumbers.o SumOfFiveNumbers.c

${OBJECTDIR}/SumOfNNumbers.o: SumOfNNumbers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SumOfNNumbers.o SumOfNNumbers.c

${OBJECTDIR}/SumOfThreeNumbers.o: SumOfThreeNumbers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SumOfThreeNumbers.o SumOfThreeNumbers.c
