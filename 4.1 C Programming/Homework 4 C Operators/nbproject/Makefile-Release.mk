...
${OBJECTDIR}/AverageSum.o: AverageSum.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AverageSum.o AverageSum.c

${OBJECTDIR}/BigAndOdd.o: BigAndOdd.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BigAndOdd.o BigAndOdd.c

${OBJECTDIR}/DivideBy7And5.o: DivideBy7And5.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DivideBy7And5.o DivideBy7And5.c

${OBJECTDIR}/FourDigitNumber.o: FourDigitNumber.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FourDigitNumber.o FourDigitNumber.c

${OBJECTDIR}/GravitationOnTheMoon.o: GravitationOnTheMoon.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GravitationOnTheMoon.o GravitationOnTheMoon.c

${OBJECTDIR}/NthDigit.o: NthDigit.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NthDigit.o NthDigit.c

${OBJECTDIR}/OddOrEvenIntegers.o: OddOrEvenIntegers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OddOrEvenIntegers.o OddOrEvenIntegers.c

${OBJECTDIR}/PointInACircle.o: PointInACircle.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PointInACircle.o PointInACircle.c

${OBJECTDIR}/PointInsideACircleAndOutsideOfARectangle.o: PointInsideACircleAndOutsideOfARectangle.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PointInsideACircleAndOutsideOfARectangle.o PointInsideACircleAndOutsideOfARectangle.c

${OBJECTDIR}/PrimeNumberCheck.o: PrimeNumberCheck.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PrimeNumberCheck.o PrimeNumberCheck.c
...
${OBJECTDIR}/ThirdDigitIsSeven.o: ThirdDigitIsSeven.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ThirdDigitIsSeven.o ThirdDigitIsSeven.c

${OBJECTDIR}/Trapezoids.o: Trapezoids.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Trapezoids.o Trapezoids.c
