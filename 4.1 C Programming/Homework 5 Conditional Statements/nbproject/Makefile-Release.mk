...
${OBJECTDIR}/BonusScore.o: BonusScore.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BonusScore.o BonusScore.c

${OBJECTDIR}/CheckForAPlayCard.o: CheckForAPlayCard.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CheckForAPlayCard.o CheckForAPlayCard.c

${OBJECTDIR}/DigitAsWord.o: DigitAsWord.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DigitAsWord.o DigitAsWord.c

${OBJECTDIR}/ExchangeIfGreater.o: ExchangeIfGreater.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExchangeIfGreater.o ExchangeIfGreater.c
...
${OBJECTDIR}/PlayWithIntDoubleAndString.o: PlayWithIntDoubleAndString.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PlayWithIntDoubleAndString.o PlayWithIntDoubleAndString.c

${OBJECTDIR}/SortThreeNumbersWithNestedIfs.o: SortThreeNumbersWithNestedIfs.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SortThreeNumbersWithNestedIfs.o SortThreeNumbersWithNestedIfs.c

${OBJECTDIR}/TheBiggestOfFiveNumbers.o: TheBiggestOfFiveNumbers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TheBiggestOfFiveNumbers.o TheBiggestOfFiveNumbers.c
