...
${OBJECTDIR}/1\ NumbersFromOneToN.o: 1\ NumbersFromOneToN.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/1\ NumbersFromOneToN.o 1\ NumbersFromOneToN.c

.NO_PARALLEL:${OBJECTDIR}/10\ OddAndEvenProduct.o
${OBJECTDIR}/10\ OddAndEvenProduct.o: 10\ OddAndEvenProduct.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/10\ OddAndEvenProduct.o 10\ OddAndEvenProduct.c
...
${OBJECTDIR}/11\ RandomNumbersInGivenRange.o: 11\ RandomNumbersInGivenRange.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/11\ RandomNumbersInGivenRange.o 11\ RandomNumbersInGivenRange.c

.NO_PARALLEL:${OBJECTDIR}/12\ RandomizeTheNumbers.o
${OBJECTDIR}/12\ RandomizeTheNumbers.o: 12\ RandomizeTheNumbers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/12\ RandomizeTheNumbers.o 12\ RandomizeTheNumbers.c

.NO_PARALLEL:${OBJECTDIR}/13\ BinaryToDecimalNumber.o
${OBJECTDIR}/13\ BinaryToDecimalNumber.o: 13\ BinaryToDecimalNumber.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/13\ BinaryToDecimalNumber.o 13\ BinaryToDecimalNumber.c

.NO_PARALLEL:${OBJECTDIR}/14\ Decimal\ to\ Binary\ Number.o
${OBJECTDIR}/14\ Decimal\ to\ Binary\ Number.o: 14\ Decimal\ to\ Binary\ Number.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/14\ Decimal\ to\ Binary\ Number.o 14\ Decimal\ to\ Binary\ Number.c
...
${OBJECTDIR}/15\ Hexadecimal\ to\ Decimal\ Number.o: 15\ Hexadecimal\ to\ Decimal\ Number.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/15\ Hexadecimal\ to\ Decimal\ Number.o 15\ Hexadecimal\ to\ Decimal\ Number.c
...
${OBJECTDIR}/16\ Decimal\ to\ Hexadecimal\ Number.o: 16\ Decimal\ to\ Hexadecimal\ Number.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/16\ Decimal\ to\ Hexadecimal\ Number.o 16\ Decimal\ to\ Hexadecimal\ Number.c

.NO_PARALLEL:${OBJECTDIR}/17\ Calculate\ GCD.o
${OBJECTDIR}/17\ Calculate\ GCD.o: 17\ Calculate\ GCD.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/17\ Calculate\ GCD.o 17\ Calculate\ GCD.c

.NO_PARALLEL:${OBJECTDIR}/18\ Trailing\ Zeroes\ in\ N.o
${OBJECTDIR}/18\ Trailing\ Zeroes\ in\ N.o: 18\ Trailing\ Zeroes\ in\ N.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/18\ Trailing\ Zeroes\ in\ N.o 18\ Trailing\ Zeroes\ in\ N.c

.NO_PARALLEL:${OBJECTDIR}/19\ Spiral\ Matrix.o
${OBJECTDIR}/19\ Spiral\ Matrix.o: 19\ Spiral\ Matrix.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/19\ Spiral\ Matrix.o 19\ Spiral\ Matrix.c
...
${OBJECTDIR}/2\ NumbersNotDivisableByThreeAndSeven.o: 2\ NumbersNotDivisableByThreeAndSeven.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/2\ NumbersNotDivisableByThreeAndSeven.o 2\ NumbersNotDivisableByThreeAndSeven.c
...
${OBJECTDIR}/3\ MinMaxSumAndAverageOfNNumbers.o: 3\ MinMaxSumAndAverageOfNNumbers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/3\ MinMaxSumAndAverageOfNNumbers.o 3\ MinMaxSumAndAverageOfNNumbers.c

.NO_PARALLEL:${OBJECTDIR}/4\ PrintADeskOf52Cards.o
${OBJECTDIR}/4\ PrintADeskOf52Cards.o: 4\ PrintADeskOf52Cards.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/4\ PrintADeskOf52Cards.o 4\ PrintADeskOf52Cards.c

.NO_PARALLEL:${OBJECTDIR}/5\ CalculateExpression.o
${OBJECTDIR}/5\ CalculateExpression.o: 5\ CalculateExpression.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/5\ CalculateExpression.o 5\ CalculateExpression.c

.NO_PARALLEL:${OBJECTDIR}/6\ CalculateExpression2.o
${OBJECTDIR}/6\ CalculateExpression2.o: 6\ CalculateExpression2.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/6\ CalculateExpression2.o 6\ CalculateExpression2.c

.NO_PARALLEL:${OBJECTDIR}/7\ CalculateExpression3.o
${OBJECTDIR}/7\ CalculateExpression3.o: 7\ CalculateExpression3.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/7\ CalculateExpression3.o 7\ CalculateExpression3.c

.NO_PARALLEL:${OBJECTDIR}/8\ CatalanNumbers.o
${OBJECTDIR}/8\ CatalanNumbers.o: 8\ CatalanNumbers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/8\ CatalanNumbers.o 8\ CatalanNumbers.c

.NO_PARALLEL:${OBJECTDIR}/9\ MatrixOfNumbers.o
${OBJECTDIR}/9\ MatrixOfNumbers.o: 9\ MatrixOfNumbers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/9\ MatrixOfNumbers.o 9\ MatrixOfNumbers.c
