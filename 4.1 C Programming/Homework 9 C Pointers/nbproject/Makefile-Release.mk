...
${OBJECTDIR}/Problem\ 1.\ Swap\ numbers.o: Problem\ 1.\ Swap\ numbers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 1.\ Swap\ numbers.o Problem\ 1.\ Swap\ numbers.c

.NO_PARALLEL:${OBJECTDIR}/Problem\ 2.\ Array\ Print.o
${OBJECTDIR}/Problem\ 2.\ Array\ Print.o: Problem\ 2.\ Array\ Print.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 2.\ Array\ Print.o Problem\ 2.\ Array\ Print.c
...
${OBJECTDIR}/Problem\ 3.\ Print\ Array\ Reversed.o: Problem\ 3.\ Print\ Array\ Reversed.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 3.\ Print\ Array\ Reversed.o Problem\ 3.\ Print\ Array\ Reversed.c
...
${OBJECTDIR}/Problem\ 4.\ Print\ Integer\ Address.o: Problem\ 4.\ Print\ Integer\ Address.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 4.\ Print\ Integer\ Address.o Problem\ 4.\ Print\ Integer\ Address.c
...
${OBJECTDIR}/Problem\ 5.\ Create\ New\ Integer.o: Problem\ 5.\ Create\ New\ Integer.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 5.\ Create\ New\ Integer.o Problem\ 5.\ Create\ New\ Integer.c

.NO_PARALLEL:${OBJECTDIR}/Problem\ 6.\ Digit\ Hate.o
${OBJECTDIR}/Problem\ 6.\ Digit\ Hate.o: Problem\ 6.\ Digit\ Hate.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 6.\ Digit\ Hate.o Problem\ 6.\ Digit\ Hate.c
...
${OBJECTDIR}/Problem\ 7.\ Generic\ Memory\ Dump\ Function.o: Problem\ 7.\ Generic\ Memory\ Dump\ Function.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 7.\ Generic\ Memory\ Dump\ Function.o Problem\ 7.\ Generic\ Memory\ Dump\ Function.c
...
${OBJECTDIR}/Problem\ 8.\ Generic\ Swap\ Function.o: Problem\ 8.\ Generic\ Swap\ Function.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 8.\ Generic\ Swap\ Function.o Problem\ 8.\ Generic\ Swap\ Function.c

.NO_PARALLEL:${OBJECTDIR}/Problem\ 9.\ Clients.o
${OBJECTDIR}/Problem\ 9.\ Clients.o: Problem\ 9.\ Clients.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problem\ 9.\ Clients.o Problem\ 9.\ Clients.c
